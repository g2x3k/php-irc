...
class BitcoinClient extends jsonrpc_client {
   ...
   */
	public function __construct($scheme, $username, $password, $address = "localhost", $port = 9332, $certificate_path = '', $debug_level = 0) {
   ...
   */
	public function validateaddress($address) {
		...
		$result = $this->query("validateaddress", $address);
		if ($result["isvalid"] == 1) {
			return $result;
		}
		else return false;
